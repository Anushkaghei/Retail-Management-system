...
def plot(connection,cursor,category,item_list,frame3):
    ...
    for i in range(len(result)):
        gl.append(result[i][0])

    xaxis = item_list
    strength = [gl.count(i) for i in item_list]
...
def tops(connection,cursor):
    item_list=["top1","top2","top3","top4","top5"]
    wink=tk.Toplevel()
    ...
    btop=tk.Button(frame1,text="top1",image=disp,compound="top",command=partial(clothing_component,connection,cursor,"TOP 1","./images/top1adesc.gif","./images/top1a.gif",600,"top1","A001","tops","F","women western wear",item_list)).pack(side=tk.LEFT)
    disp1=tk.PhotoImage(file="./images/top2a.gif")
    btop1=tk.Button(frame1,text="top2",image=disp1,compound="top",command=partial(clothing_component,connection,cursor,"TOP 2","./images/top2adesc.gif","./images/top2a.gif",500,"top2","A002","tops","F","women western wear",item_list)).pack(side=tk.LEFT)
    disp2=tk.PhotoImage(file="./images/top3a.gif")
    btop2=tk.Button(frame1,text="top3",image=disp2,compound="top",command=partial(clothing_component,connection,cursor,"TOP 3","./images/top3adesc.gif","./images/top3a.gif",650,"top3","A003","tops","F","women western wear",item_list)).pack(side=tk.LEFT)
    disp3=tk.PhotoImage(file="./images/top4a.gif")
    btop3=tk.Button(frame2,text="top4",image=disp3,compound="top",command=partial(clothing_component,connection,cursor,"TOP 4","./images/top4adesc.gif","./images/top4a.gif",600,"top4","A004","tops","F","women western wear",item_list)).pack(side=tk.LEFT)
    disp4=tk.PhotoImage(file="./images/top5a.gif")
    btop4=tk.Button(frame2,text="top5",image=disp4,compound="top",command=partial(clothing_component,connection,cursor,"TOP 5","./images/top5adesc.gif","./images/top5a.gif",400,"top5","A005","tops","F","women western wear",item_list)).pack(side=tk.LEFT)
...
def dresses(connection,cursor):
    item_list=["dress1","dress2","dress3","dress4"]
    choice2=tk.Toplevel()
    ...
    btopa=tk.Button(choice2,text="dress1",image=dispa,compound="top",command=partial(clothing_component,connection,cursor,"DRESS 1","./images/dress1adesc.gif","./images/dress1a.gif",900,"dress1","B001","dresses","F","women western wear",item_list)).pack(side=tk.LEFT)
    dispb=tk.PhotoImage(file="./images/dress2a.gif")
    btopb=tk.Button(choice2,text="dress2",image=dispb,compound="top",command=partial(clothing_component,connection,cursor,"DRESS 2","./images/dress2adesc.gif","./images/dress2a.gif",700,"dress2","B002","dresses","F","women western wear",item_list)).pack(side=tk.LEFT)
    dispc=tk.PhotoImage(file="./images/dress3a.gif")
    btopc=tk.Button(choice2,text="dress3",image=dispc,compound="top",command=partial(clothing_component,connection,cursor,"DRESS 3","./images/dress3adesc.gif","./images/dress3a.gif",800,"dress3","B003","dresses","F","women western wear",item_list)).pack(side=tk.LEFT)
    dispd=tk.PhotoImage(file="./images/dress4a.gif")
    btopd=tk.Button(choice2,text="dress4",image=dispd,compound="top",command=partial(clothing_component,connection,cursor,"DRESS 4","./images/dress4adesc.gif","./images/dress4a.gif",800,"dress4","B004","dresses","F","women western wear",item_list)).pack(side=tk.LEFT)
    choice2.mainloop()

def jeans(connection,cursor):
    item_list=["jeans1","jeans2","jeans3","jeans4"]
    choice3=tk.Toplevel()
    ...
    btop6=tk.Button(choice3,text="jeans1",image=disp6,compound="top",command=partial(clothing_component,connection,cursor,"JEANS 1","./images/jeans1adesc.gif","./images/jeans1a.gif",800,"jeans1","C001","jeans","F","women western wear",item_list)).pack(side=tk.LEFT)
    disp7=tk.PhotoImage(file="./images/jeans2a.gif")
    btop7=tk.Button(choice3,text="jeans2",image=disp7,compound="top",command=partial(clothing_component,connection,cursor,"JEANS 2","./images/jeans2adesc.gif","./images/jeans2a.gif",1050,"jeans2","C002","jeans","F","women western wear",item_list)).pack(side=tk.LEFT)
    disp8=tk.PhotoImage(file="./images/jeans3a.gif")
    btop8=tk.Button(choice3,text="jeans3",image=disp8,compound="top",command=partial(clothing_component,connection,cursor,"JEANS 3","./images/jeans3adesc.gif","./images/jeans3a.gif",900,"jeans3","C003","jeans","F","women western wear",item_list)).pack(side=tk.LEFT)
    disp10=tk.PhotoImage(file="./images/jeans4a.gif")
    btop10=tk.Button(choice3,text="jeans4",image=disp10,compound="top",command=partial(clothing_component,connection,cursor,"JEANS 4","./images/jeans4adesc.gif","./images/jeans4a.gif",1000,"jeans4","C004","jeans","F","women western wear",item_list)).pack(side=tk.LEFT)
    choice3.mainloop()

def kurta(connection,cursor):
    item_list=["kurta1","kurta2","kurta3","kurta4"]
    kurti=tk.Toplevel()
    ...
    kt1=tk.Button(kurti,text="kurta1",image=k1,compound="top",command=partial(clothing_component,connection,cursor,"KURTA 1","./images/kurta1adesc.gif","./images/kurta1a.gif",900,"kurta1","D001","kurtas","F","women ethnic wear",item_list)).pack(side=tk.LEFT)
    k2=tk.PhotoImage(file="./images/kurta2.gif")
    kt2=tk.Button(kurti,text="kurta2",image=k2,compound="top",command=partial(clothing_component,connection,cursor,"KURTA 2","./images/kurta2adesc.gif","./images/kurta2a.gif",600,"kurta2","D002","kurtas","F","women ethnic wear",item_list)).pack(side=tk.LEFT)
    k3=tk.PhotoImage(file="./images/kurta3.gif")
    kt3=tk.Button(kurti,text="kurta3",image=k3,compound="top",command=partial(clothing_component,connection,cursor,"KURTA 3","./images/kurta3adesc.gif","./images/kurta3a.gif",800,"kurta3","D003","kurtas","F","women ethnic wear",item_list)).pack(side=tk.LEFT)
    k4=tk.PhotoImage(file="./images/kurta4.gif")
    kt4=tk.Button(kurti,text="kurta4",image=k4,compound="top",command=partial(clothing_component,connection,cursor,"KURTA 4","./images/kurta4adesc.gif","./images/kurta4a.gif",1000,"kurta4","D004","kurtas","F","women ethnic wear",item_list)).pack(side=tk.LEFT)
    kurti.mainloop() 

def lehenga(connection,cursor):
    item_list=["lehenga1","lehenga2","saree1","saree2"]
    l=tk.Toplevel()
    ...
    ln1=tk.Button(l,text="lehenga1",image=l1,compound="top",command=partial(clothing_component,connection,cursor,"LEHENGA 1","./images/lehenga1desc.gif","./images/lehenga1.gif",3000,"lehenga1","E001","lehengas","F","women ethnic wear",item_list)).pack(side=tk.LEFT)
    l2=tk.PhotoImage(file="./images/lehenga2.gif")
    ln2=tk.Button(l,text="lehenga2",image=l2,compound="top",command=partial(clothing_component,connection,cursor,"LEHENGA 2","./images/lehenga2desc.gif","./images/lehenga2.gif",5000,"lehenga2","E002","lehengas","F","women ethnic wear",item_list)).pack(side=tk.LEFT)
    l3=tk.PhotoImage(file="./images/saree1.gif")
    ln3=tk.Button(l,text="saree1",image=l3,compound="top",command=partial(clothing_component,connection,cursor,"SAREE 1","./images/saree1desc.gif","./images/saree1.gif",4000,"saree1","E003","lehengas","F","women ethnic wear",item_list)).pack(side=tk.LEFT)
    l4=tk.PhotoImage(file="./images/saree2.gif")
    ln4=tk.Button(l,text="saree2",image=l4,compound="top",command=partial(clothing_component,connection,cursor,"SAREE 2","./images/saree2desc.gif","./images/saree2.gif",3000,"saree2","E004","lehengas","F","women ethnic wear",item_list)).pack(side=tk.LEFT)
    l.mainloop() 

def men_kurtas(connection,cursor):
    item_list=["ethnic1","ethnic2","ethnic3","ethnic4"]
    wink=tk.Toplevel()
    wink.geometry("1700x800+0+0")
    wink.config(background="seashell3")
    ...
    et=tk.Button(wink,text="ethnic1",image=e,compound="top",command=partial(clothing_component,connection,cursor,"ETHNIC 1","./images/eth1desc.gif","./images/eth1.gif",1500,"ethnic1","H001","ethnic","M","men ethnic wear",item_list)).pack(side=tk.LEFT)
    e1=tk.PhotoImage(file="./images/eth2.gif")
    et1=tk.Button(wink,text="ethnic2",image=e1,compound="top",command=partial(clothing_component,connection,cursor,"ETHNIC 2","./images/eth2desc.gif","./images/eth2.gif",980,"ethnic2","H002","ethnic","M","men ethnic wear",item_list)).pack(side=tk.LEFT)
    e2=tk.PhotoImage(file="./images/eth3.gif")
    et2=tk.Button(wink,text="ethnic3",image=e2,compound="top",command=partial(clothing_component,connection,cursor,"ETHNIC 3","./images/eth3desc.gif","./images/eth3.gif",780,"ethnic3","H003","ethnic","M","men ethnic wear",item_list)).pack(side=tk.LEFT)
    e3=tk.PhotoImage(file="./images/eth4.gif")
    et3=tk.Button(wink,text="ethnic4",image=e3,compound="top",command=partial(clothing_component,connection,cursor,"ETHNIC 4","./images/eth4desc.gif","./images/eth4.gif",1000,"ethnic1","H004","ethnic","M","men ethnic wear",item_list)).pack(side=tk.LEFT)
    wink.mainloop()  

def shirt(connection,cursor):
    item_list=["shirt1","shirt2","shirt3","shirt4"]
    ...
    et=tk.Button(tee,text="shirt1",image=e,compound="top",command=partial(clothing_component,connection,cursor,"SHIRT 1","./images/shirt1desc.gif","./images/shirt1.gif",1500,"shirt1","F001","shirts","M","men western wear",item_list)).pack(side=tk.LEFT)
    e1=tk.PhotoImage(file="./images/shirt2.gif")
    et1=tk.Button(tee,text="shirt2",image=e1,compound="top",command=partial(clothing_component,connection,cursor,"SHIRT 2","./images/shirt2desc.gif","./images/shirt2.gif",900,"shirt2","F002","shirts","M","men western wear",item_list)).pack(side=tk.LEFT)
    e2=tk.PhotoImage(file="./images/shirt3.gif")
    et2=tk.Button(tee,text="shirt3",image=e2,compound="top",command=partial(clothing_component,connection,cursor,"SHIRT 3","./images/shirt3desc.gif","./images/shirt3.gif",650,"shirt3","F003","shirts","M","men western wear",item_list)).pack(side=tk.LEFT)
    e3=tk.PhotoImage(file="./images/shirt4.gif")
    et3=tk.Button(tee,text="shirt4",image=e3,compound="top",command=partial(clothing_component,connection,cursor,"SHIRT 4","./images/shirt4desc.gif","./images/shirt4.gif",700,"shirt1","F004","shirts","M","men western wear",item_list)).pack(side=tk.LEFT)
    tee.mainloop() 

def denims(connection,cursor):
    item_list=["denim1","denim2","denim3","denim4"]
    ...
    et=tk.Button(tee,text="denim1",image=e,compound="top",command=partial(clothing_component,connection,cursor,"DENIM 1","./images/mjeans1desc.gif","./images/mjeans1.gif",650,"denim1","G001","denims","M","men western wear",item_list)).pack(side=tk.LEFT)
    e1=tk.PhotoImage(file="./images/mjeans2.gif")
    et1=tk.Button(tee,text="denim2",image=e1,compound="top",command=partial(clothing_component,connection,cursor,"DENIM 2","./images/mjeans2desc.gif","./images/mjeans2.gif",900,"denim2","G002","denims","M","men western wear",item_list)).pack(side=tk.LEFT)
    e2=tk.PhotoImage(file="./images/mjeans3.gif")
    et2=tk.Button(tee,text="denim3",image=e2,compound="top",command=partial(clothing_component,connection,cursor,"DENIM 3","./images/mjeans3desc.gif","./images/mjeans3.gif",1000,"denim3","G003","denims","M","men western wear",item_list)).pack(side=tk.LEFT)
    e3=tk.PhotoImage(file="../images/mjeans4.gif")
    et3=tk.Button(tee,text="denim4",image=e3,compound="top",command=partial(clothing_component,connection,cursor,"DENIM 4","./images/mjeans4desc.gif","./images/mjeans4.gif",700,"denim4","G004","denims","M","men western wear",item_list)).pack(side=tk.LEFT)
    tee.mainloop() 
...
def clothing_component(connection,cursor,title,img_desc,img_fit,amount,name,model,category,gender,maincat,item_list):
    met3=tk.Toplevel()
    ...
    tk.Label(frame1).pack()
    b1s=tk.Button(frame1,text="Add to cart",highlightbackground="yellow",command=partial(product,connection,cursor,name,amount,category,maincat),bg="snow").pack()
    tk.Label(frame1).pack()
    ...
    plot(connection,cursor,category,item_list,frame3)
...
def product(connection,cursor,name,amount,category,product_description):
    read_query="insert into products(itemname,price,category,product_description) values(%s,%s,%s,%s)"
    values=(name,amount,category,product_description)
    cursor.execute(read_query,values)
    connection.commit()
    print("new record inserted")